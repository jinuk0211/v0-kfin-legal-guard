...
2. Do NOT cite or invent case law or statutes. Verified grounding (CourtListener precedents) is attached by a separate stage, so OMIT legal_grounds entirely from your output.
